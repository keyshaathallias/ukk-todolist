  ...
  <section class="mx-12 mt-5">
      ...
      <ol class="inline-flex items-center space-x-1">
        ...
        <li aria-current="page">
          <div class="flex items-center">
            ...
            <span class="text-sm font-medium text-dark-green ms-1">Task Name</span>
          </div>
        </li>
      </ol>
    </nav>
    ...
    <main class="flex justify-center mt-3 w-[580px] mx-auto flex-col bg-white p-5 rounded-lg shadow">
      <div class="flex items-center gap-5 mb-3">
        ...
        <h2 class="text-lg font-semibold">Membuat frontend To-Do List</h2>
      </div>

      <div class="mb-5 ms-9">
        <h5 class="mb-1 font-semibold">Description</h5>
        <p class="text-sm font-lato-regular">Lorem ipsum dolor sit amet consectetur adipisicing elit. Ullam ut nihil
          commodi eveniet quis
          magnam</p>
      </div>
      <div class="mb-5 ms-9">
        <h5 class="mb-1 font-semibold">Priority</h5>
        <p class="px-3 py-1 text-sm text-white rounded-full w-fit font-lato-regular bg-red">
          • High
        </p>
      </div>
      <div class="mb-5 ms-9">
        <h5 class="mb-1 font-semibold">Status</h5>
        <p class="px-3 py-1 text-sm rounded-full w-fit font-lato-regular bg-purple">
          Ongoing
        </p>
      </div>
      <div class="mb-5 ms-9">
        <h5 class="mb-1 font-semibold">Due Date</h5>
