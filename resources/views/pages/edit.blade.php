      ...
      <ol class="inline-flex items-center space-x-1">
        ...
        <li aria-current="page">
          <div class="flex items-center">
            <svg class="w-3 h-3 mx-1 text-green rtl:rotate-180" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
              fill="none" viewBox="0 0 6 10">
              <path stroke="#789F40" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 9 4-4-4-4" />
            </svg>
            <span class="text-sm font-medium text-green ms-1">Edit Task</span>
          </div>
        </li>
      </ol>
    </nav>
    ...
    <main class="flex flex-col justify-center w-[580px] py-5 px-7 mx-auto mt-3 bg-white rounded-lg shadow">
      <form action="" method="POST">
        ...
        <div class="flex flex-col gap-2 mb-4">
          ...
          <input type="text" id="name" name="name" class="px-4 py-2 text-sm border rounded border-dark-green"
            value="Nama Tugas">
        </div>
        <div class="flex flex-col gap-2 mb-4">
          <label class="text-sm" for="description">Description</label>
          <textarea name="description" id="description" cols="30" rows="3"
            class="px-4 py-2 text-sm border rounded border-dark-green">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Dolorum temporibus, illum expedita impedit voluptas delectus.</textarea>
        </div>
        <div class="flex flex-col gap-2 mb-4">
        ...
        <div class="flex flex-col gap-2 mb-4">
          ...
          <input type="date" id="due_date" name="due_date" placeholder=""
            class="px-4 py-2 text-sm border rounded border-dark-green"
            value="">
        </div>
